import 'package:api_project/core/theme/custom_text_style.dart';
        ...
        children: [
          ...
          Row(
            children: [
              IconButton(
                  onPressed: () {
                    final desc = controller.todayWeatherData.value?.warningDesc;
                    controller.pushNotification(desc ?? "우산챙겨라");
                  },
