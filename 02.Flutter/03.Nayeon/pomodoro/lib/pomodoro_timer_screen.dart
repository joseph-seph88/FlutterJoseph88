...
class PomodoroTimerScreenState extends State<PomodoroTimerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          'Egg Time',
          style: TextStyle(fontFamily: 'Hyemin_Bold', color: yellowstyle7),
        ),
      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: [
            DrawerHeader(
              decoration: BoxDecoration(color: yellowstyle3),
              child: Text(
                'Egg Timer Menu',
                  ...
                  Center(
                    child: ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        ...
                        foregroundColor: yellowstyle6,
                        backgroundColor: basestyle1,
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        selectedItemColor: yellowstyle6,
        unselectedItemColor: yellowstyle6,
        backgroundColor: basestyle2,
        items: [
  ...
  ListTile buildDrawerItem(IconData icon, String title, VoidCallback onTap) {
    return ListTile(
      leading: Icon(icon, color: yellowstyle6),
      title: Text(title),
      onTap: onTap,
    );
  }
