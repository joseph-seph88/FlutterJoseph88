...
void main() {
  ...
  if (inputStart == null || int.tryParse(inputStart) == null) {
    print("유효한 숫자를 입력하세요.");
    return;
  }
  int start = int.parse(inputStart);

  String? inputBefore = stdin.readLineSync();
  if (inputBefore == null || int.tryParse(inputBefore) == null) {
    print("유효한 숫자를 입력하세요.");
    return;
  }
  //int before = int.parse(inputBefore);

  String? inputAfter = stdin.readLineSync();
  if (inputAfter == null || int.tryParse(inputAfter) == null) {
    print("유효한 숫자를 입력하세요.");
    return;
  }
  //int after = int.parse(inputAfter);
