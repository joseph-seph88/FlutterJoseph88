...
void main() {
  List<int> bandage1 = [5, 1, 5];
  int health1 = 30;
  List<List<int>> attacks1 = [
    [2, 10],
    [9, 15],
    [10, 5],
    [11, 5]
  ...
  List<int> bandage2 = [3, 2, 7];
  int health2 = 20;
  List<List<int>> attacks2 = [
    [1, 15],
    [5, 16],
    [8, 6]
  ];
  ...
  List<int> bandage3 = [4, 2, 7];
  int health3 = 20;
  List<List<int>> attacks3 = [
    [1, 15],
    [5, 16],
    [8, 6]
  ];
  ...
  List<int> bandage4 = [1, 1, 1];
  int health4 = 5;
  List<List<int>> attacks4 = [
    [1, 2],
    [3, 2]
  ];
  // output : 3
  ...
  print(solution.solution(bandage1, health1, attacks1));
  print(solution.solution(bandage2, health2, attacks2));
  print(solution.solution(bandage3, health3, attacks3));
  print(solution.solution(bandage4, health4, attacks4));
}

class Solution {
  int solution(List<int> bandage, int health, List<List<int>> attacks) {
    int answer = 0;
